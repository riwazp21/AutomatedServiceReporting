             ...
             {     
                ...
                else
                {
                       ...
                       // $newHour = getValue($_POST["hours"]);
                        ...
                        $param = array($id);
                        $pdoStatement1 = $pdo->prepare(sqlDeleteQuery());
     ...
     <body class="w3-panel">
         ...
         <main class="w3-panel">
            ...
            <p>
                ...
                <label>Delete for record id: <?php echo idDropDown(); ?></label>
            </p>

            <p>
                        <button class="w3-button w3-green w3-round" name="insertButton" value="insert">Delete Record</button>
            </p>
            </form>
